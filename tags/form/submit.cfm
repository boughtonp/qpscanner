...
<cfswitch expression="#UCase(ThisTag.ExecutionMode)#">
	<cfcase value="START">
		...
		--->
			...
			<!--- Standard Attributes: --->
			<cfparam name="Attributes.Value"       type="String"  default="Submit"/>

			<!--- Other Attributes: --->
			<cfparam name="Attributes.Type"        type="String"  default="submit"/>
	...
	<cfcase value="END">
		...
		--->
			...
			<cfoutput><button #ThisTag.PFCT.readAttributes(Attributes,'{ALL}','highlightaccesskey')#>#Attributes.Value&ThisTag.GeneratedContent#</button></cfoutput>
